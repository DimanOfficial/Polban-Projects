...
<div class="container mt-5">
    ...
    <form action="/pengunjung/rincian" method="get" class="mb-3">
        <div class="input-group">
            ...
            <a href="/pengunjung/rincian" class="btn btn-secondary">Reset</a>
        </div>
    </form>

    <div class="table-responsive">
        <table class="table table-bordered shadow-sm" id="mydatatable">
            ...
            <tbody style="background-color: white; font-size: 14px;">
                <?php if (count($kegiatan) > 0): ?>
                    <?php $no = 1 + (5 * ($pager->getCurrentPage('pengunjung') - 1)); ?>
