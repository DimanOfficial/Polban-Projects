...
<div class="container">
    ...
    <form action="/dashboard/pembuat/update/<?= $kegiatan['id_kegiatan'] ?>" method="post" enctype="multipart/form-data"> <!-- Tambahkan enctype -->
        <?= csrf_field(); ?>
        ...
        <a href="/dashboard/pembuat/kegiatan" class="btn btn-secondary mt-3">Kembali</a>
    </form>
</div>
</div>
<!-- End of Page Content -->
